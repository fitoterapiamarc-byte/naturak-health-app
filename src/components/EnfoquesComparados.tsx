...
function EnfoquesComparados({ condicion, bloquearIntervencionesNaturales = false }: EnfoquesComparadosProps) {
  ...
  const ejemplos = ejemplosConEvidencia[condicion.id] ?? ejemplosConEvidenciaExtra[condicion.id] ?? ejemplosConEvidenciaComplementarios[condicion.id] ?? ejemplosEmocionales[condicion.id];
