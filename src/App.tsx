...
function App() {
  ...
  return <>
    ...
    <section aria-label="Cobertura de la aplicación" style={{maxWidth:"1100px",margin:"16px auto 0",padding:"22px 24px",borderRadius:"14px",background:"#ffffff",border:"1px solid #d7e2dc",fontFamily:"Arial, sans-serif",textAlign:"center"}}>
      <div style={{fontSize:"30px",fontWeight:800,color:"#214c3b",marginBottom:"6px"}}>Más de {cifraPortadaCondiciones} condiciones y problemas de salud comunes</div>
      <div style={{fontSize:"16px",color:"#4d6259",lineHeight:1.5}}>Actualmente la base incluye {totalCondiciones} cuadros de orientación, con evaluación de síntomas, señales de alarma y posibles medidas de apoyo mediante nutrición y fitoterapia.</div>
    </section>
    <ModuloTensionArterial />
    <main style={{padding:"30px",fontFamily:"Arial, sans-serif",background:"#f4f8f7",minHeight:"100vh"}}><EvaluacionIntegral key={sesionEvaluacion}/></main>
  </>;
}
export default App;