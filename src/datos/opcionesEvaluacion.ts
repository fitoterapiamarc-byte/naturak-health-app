...
export const categoriasEvaluacion: CategoriaEvaluacion[] = [
  ...
  },
  {
    ...
    opciones: [
      ...
      "Erupción cerca del ojo",
      "Enrojecimiento casi generalizado",
      "Enrojecimiento que avanza rápidamente",
      "Líneas rojas que ascienden por la extremidad",
      "Erupción muy extendida",
    ],
  },
  {
